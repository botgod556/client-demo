...
class GPIOMonitor:
    ...
    def pin_pressed(self, pin):
        ...
        logger.info(f"Pin {pin} changed to LOW (pressed), was HIGH for {time_diff_sec:.2f}ms")
    ...
    def pin_released(self, pin):
        ...
        logger.info(f"Pin {pin} changed to HIGH (released), was LOW for {time_diff_sec:.2f}ms")
    ...
    def send_data_to_server(self, pin, state, time_diff_sec):
        ...
        data = {
            ...
            'time_diff_ms': round(time_diff_sec, 2),
